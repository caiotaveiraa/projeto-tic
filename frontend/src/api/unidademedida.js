export const buscaUnidades = async () => {
    try {
  ...
  export const deletaUnidade = async (unidadeId) => {
    try {
      const resp = await fetch(`http://localhost:3333/unidadeMedida/delete/${unidadeId}`, {
  ...
  export const novaUnidade = async (dados, insercao) => {
    let verbo
    let url
    if(insercao)
    {
