...
export default function TiposProdutos()  {
  ...
  // fazer o hook useEffect para carregar os locais da API
    ...
    const handleEdit = (Tipo: tiposProdutosProps) => {
      ...
      setIdTipProd(Tipo.idtipprod) // usado para eu filtrar se é uma criação ou edição do local
    }
    ...
    const Tipo = {
      ...
      try {
        ...
        const TipoCadastrado = await fetch(`http://localhost:3333/tiposProdutos/add`, {
          method: 'POST',
          headers: {
